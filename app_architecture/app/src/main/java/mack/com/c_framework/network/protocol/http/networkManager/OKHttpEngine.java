package mack.com.c_framework.network.protocol.http.networkManager;
...
import mack.com.c_framework.BaseApplication;
import mack.com.c_framework.network.protocol.http.networkManager.http.HttpCallBack;
import mack.com.c_framework.network.protocol.http.networkManager.http.IHttpEngine;
import mack.com.c_framework.network.protocol.http.networkManager.http.XHttp;
...
public class OKHttpEngine implements IHttpEngine {
    ...
    public OKHttpEngine() {
        client = new OkHttpClient().newBuilder()
                ...
                .cache(new Cache(BaseApplication.getContext().getCacheDir(), cacheSize))
                .build();
    }
