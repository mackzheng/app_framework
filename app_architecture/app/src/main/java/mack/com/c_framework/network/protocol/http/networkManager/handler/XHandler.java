package mack.com.c_framework.network.protocol.http.networkManager.handler;
...
public class XHandler {
     ...
     */
    public XHandler(@Nullable Handler.Callback callback) {
     ...
     */
    public XHandler(@NonNull Looper looper) {
        mCallback = null;
